...
- efeitos de domínio: baixa física somente da quantidade entregue, consumo da reserva entregue, liberação da reserva não entregue e status `atendida` ou `atendida_parcialmente`.
